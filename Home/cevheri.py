...
if __name__ == "__main__":
    ...
    parser.add_argument('--gun-confidence', type=float, default=0.5, help='Gun confidence')
    parser.add_argument('--plate-confidence', type=float, default=0.6, help='Plate confidence')
